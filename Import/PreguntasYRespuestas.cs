    ...
    public class CargandoPreguntasYRespuestas
    {
        ...
        public CargandoPreguntasYRespuestas()
        {
            ListaPreguntas = new List<PreguntasyRespuestas>
            {
                ...
                new PreguntasyRespuestas("Quien mato al padre de Goku?", new List<string> { "Freezer", "Rey Vegeta", "Bills" }, 0), // Respuesta correcta: Rey Vegeta (índice 1)
                ...
                new PreguntasyRespuestas("De las esferas del dragon, cual es el numero de la suerte de Goku?", new List<string> { "7", "2", "4" }, 2), // Respuesta correcta: 7 (índice 0)
